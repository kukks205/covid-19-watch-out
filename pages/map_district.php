        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                popup.show(evt.coordinate,
                    ...
                    /*'<div class="row"><div class="col-md-6"><b>' + feature.get('subdistname') + '</div><div class="col-md-6"><a href="index.php?url=pages/sum_risk_dist.php&distcode='+feature.get('distcode')+'" class="btn btn-sm btn-info">รายละเอียด</a></b></div> </div>' +
                    '<div class="line"></div><b>' + str + '</b>');*/
            }
        });
